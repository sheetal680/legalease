...
const CATEGORY_STYLES = {
  ...
  constitutional: { label: 'Constitutional', bg: 'bg-violet-50',  text: 'text-violet-700',  border: 'border-violet-200'  },
  'ni-act':       { label: 'NI Act',         bg: 'bg-rose-50',    text: 'text-rose-700',    border: 'border-rose-200'    },
  corporate:      { label: 'Corporate',      bg: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-200' },
  ...
  return (
    <div className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col overflow-hidden">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {/* Name */}
        <h3 className="text-sm font-bold text-[#1e3a5f] leading-snug group-hover:text-[#2a5298] transition-colors flex-1 mb-4">
          {template.name}
        </h3>
