    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-gray-100 p-8 flex flex-col items-center text-center">
        ...
        <Link to="/" className="flex items-center gap-2 mb-8">
          ...
          <span className="text-2xl font-bold text-[#1e3a5f] tracking-tight">LegalEase</span>
        </Link>

        <h1 className="text-xl font-bold text-[#1e3a5f] mb-1">Welcome back</h1>
        ...
        <p className="mt-8 text-xs text-gray-400 leading-relaxed">
          ...
          <span className="text-[#1e3a5f] underline cursor-pointer">Terms of Service</span>{' '}
          and{' '}
          <span className="text-[#1e3a5f] underline cursor-pointer">Privacy Policy</span>.
        </p>
      </div>
