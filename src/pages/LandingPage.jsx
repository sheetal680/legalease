...
export default function LandingPage() {
  ...
  useEffect(() => {
    document.title =
      'LegalEase — AI Legal Document Drafting for Indian Lawyers'
  }, [])
      ...
      <section className="bg-[#1e3a5f] text-white py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-200 max-w-2xl mx-auto mb-10">
            Smart templates, auto-filled with your details,
            ready in seconds.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Purpose-built for legal professionals who value their time and
              their clients' trust.
            </p>
          </div>
      ...
      <section className="bg-[#1e3a5f] py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-12">
            From login to letterhead in 60 seconds
          </h2>
            ...
            {[
              {
                ...
                desc: 'One click, no passwords, instant access.',
              },
              {
                step: '02',
                title: 'Complete your profile',
                desc: 'Enter your bar number and firm details once.',
              },
              {
                step: '03',
                title: 'Pick a template & export',
                desc: 'Auto-filled, formatted, and ready to serve.',
              },
            ].map(({ step, title, desc }) => (
              <div key={step} className="flex gap-4">
                <span className="text-4xl font-black text-[#c9a84c]/30 leading-none">
                  {step}
                </span>
